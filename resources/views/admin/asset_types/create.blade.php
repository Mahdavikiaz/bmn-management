...
@section('title', 'SIMANIS | Tambah Tipe Asset')

@section('content')

<div class="d-flex justify-content-between align-items-center mb-0">
    <div>
        <h4 class="mb-2">Tambah Tipe Asset</h4>
        <p class="text-muted">Form untuk menambahkan tipe asset baru</p>
    </div>
