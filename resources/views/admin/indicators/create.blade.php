...
<div class="card shadow-sm border-0">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('admin.indicator-questions.store') }}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <textarea name="question"
                          ...
                          placeholder="Masukkan pertanyaan yang akan dijawab oleh user"
                ...
                @foreach($labels as $label)
                    <div class="option-card mb-3">
                        ...
                        <input type="text"
                               ...
                               placeholder="Masukkan opsi jawaban {{ $label }}"
                               required>
